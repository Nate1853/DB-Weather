...
public class Weather {
	 ...
	 * @param weatherStateName Englischsprachige Beschreibung des Wetters.
	 * @param applicableDate Datum, fuer das die Vorhersage gueltig ist.
	 * @param minTemp Tagestiefstemperatur.
	 * @param maxTemp Tageshoechstemperatur.
	 * @param airPressure Luftdruck in mbar.
	 * @param humidity Relative Luftfeuchtigkeit.
	 */
	public Weather(long id, String weatherStateName, Date applicableDate, float minTemp, float maxTemp, int airPressure, int humidity) {
		this.id = id;
