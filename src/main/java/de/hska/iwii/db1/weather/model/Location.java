...
public class Location {
	...
	/**
	 * Erzeugt eine neue Ortsangabe.
	 * @param name Name der Ortsangabe.
	 * @param locationType Art der Ortsangabe.
	 * @param id ID der Ortsangabe.
	 * @param lattitudeLongitude Laengen- und Breitengrad der Ortsangabe.
	 */
	public Location(String name, String locationType, long id, String lattitudeLongitude) {
		this.name = name;
